...
public class TAEAnalyze extends DefaultFlexoObject implements PropertyChangeListener {

	private final VirtualModelInstance virtualModelInstance;

	public TAEAnalyze(VirtualModelInstance virtualModelInstance) throws InvalidArgumentException {
		super();
