...
public class TAEContext extends DefaultFlexoObject implements PropertyChangeListener {

	private final VirtualModelInstance virtualModelInstance;

	public TAEContext(VirtualModelInstance virtualModelInstance) throws InvalidArgumentException {
		super();
