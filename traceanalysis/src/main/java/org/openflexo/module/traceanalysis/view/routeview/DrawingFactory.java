...
public class DrawingFactory {
	...
	public ShapeGraphicalRepresentation createDefaultStateRepresentation(double width, double height){
		...
		defaultStateRepresentation.setTextStyle(factory.makeTextStyle(Color.BLACK,
	...
	public ConnectorGraphicalRepresentation createConcreteTransitionRepresentation(){
		ConnectorGraphicalRepresentation concreteTransitionRepresentation = factory.makeConnectorGraphicalRepresentation(ConnectorType.LINE);
	...
	public ShapeGraphicalRepresentation createConfigurationRepresentation(){
		...
		configurationRepresentation.setTextStyle(factory.makeTextStyle(Color.BLACK,
		...
		configurationRepresentation.setBackground(factory.makeColorGradientBackground(FGEConstants.DEFAULT_BACKGROUND_COLOR,
	...
	public ShapeGraphicalRepresentation createIntermediateConfigurationRepresentation(){
		...
		intermediateConfigurationRepresentation.setTextStyle(factory.makeTextStyle(Color.LIGHT_GRAY,
		...
		intermediateConfigurationRepresentation.setBackground(factory.makeColorGradientBackground(Color.LIGHT_GRAY, Color.white,
	...
	public ShapeGraphicalRepresentation createLifeLineRepresentation(){
		...
		lifeLineRepresentation.setTextStyle(factory.makeTextStyle(Color.DARK_GRAY,
				FGEConstants.DEFAULT_TEXT_FONT.deriveFont(Font.BOLD)));
	...
	private ShapeGraphicalRepresentation createObserverStateRepresentation(double width, double height,Resource resource){
		...
		rejectStateRepresentation.setTextStyle(factory.makeTextStyle(Color.BLACK,
				FGEConstants.DEFAULT_TEXT_FONT.deriveFont(Font.PLAIN)));
