...
@ModelEntity
@ImplementationClass(OBPTraceProcessInstance.OBPTraceProcessInstanceImpl.class)
@XMLElement(xmlTag = "OBPTraceProcessInstance")
public interface OBPTraceProcessInstance extends OBPTraceBehaviourObjectInstance {
	
	public static abstract class OBPTraceProcessInstanceImpl extends OBPTraceBehaviourObjectInstanceImpl implements OBPTraceProcessInstance {
		
		static private String REGEX = "(\\w+)(\\d+)";
		...
		public OBPTraceProcessInstanceImpl() {
