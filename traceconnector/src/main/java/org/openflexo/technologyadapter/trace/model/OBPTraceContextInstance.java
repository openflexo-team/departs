...
@ModelEntity
@ImplementationClass(OBPTraceContextInstance.OBPTraceContextInstanceImpl.class)
@XMLElement(xmlTag = "OBPTraceContextInstance")
public interface OBPTraceContextInstance extends OBPTraceBehaviourObjectInstance {

	public static abstract class OBPTraceContextInstanceImpl extends OBPTraceBehaviourObjectInstanceImpl implements OBPTraceContextInstance {

		private static final String REGEX = "\\{{1}(\\w+)\\}{1}(\\d+)";
		...
		public OBPTraceContextInstanceImpl() {
