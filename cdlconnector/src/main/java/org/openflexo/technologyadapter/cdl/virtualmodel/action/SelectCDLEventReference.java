...
public interface SelectCDLEventReference extends FetchRequest<CDLModelSlot, CDLEventReference> {
	...
	public static abstract class SelectCDLEventReferenceImpl extends FetchRequestImpl<CDLModelSlot, CDLEventReference> implements SelectCDLEventReference {
		...
		@Override
		public List<CDLEventReference> performAction(FlexoBehaviourAction action) {
