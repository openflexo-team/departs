...
public interface CDLParActivityRole extends FlexoRole<CDLParActivity> {
	...
	public static abstract class CDLParActivityRoleImpl extends FlexoRoleImpl<CDLParActivity>implements CDLParActivityRole {
		...
		@Override
		public ActorReference<CDLParActivity> makeActorReference(CDLParActivity object, FlexoConceptInstance epi) {
			AbstractVirtualModelInstanceModelFactory<?> factory = epi.getFactory();
			ModelObjectActorReference<CDLParActivity> returned = factory.newInstance(ModelObjectActorReference.class);
