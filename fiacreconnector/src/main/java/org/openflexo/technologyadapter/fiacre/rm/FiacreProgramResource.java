...
@ModelEntity
@ImplementationClass(FiacreProgramResourceImpl.class)
public abstract interface FiacreProgramResource extends FlexoFileResource<FiacreProgram>, TechnologyAdapterResource<FiacreProgram, FiacreTechnologyAdapter> {
	...
	public abstract FiacreTechnologyContextManager getTechnologyContextManager();

	@Setter("technologyContextManager")
	public abstract void setTechnologyContextManager(FiacreTechnologyContextManager paramCDLTechnologyContextManager);

	public abstract FiacreProgramConverter getConverter();
}
